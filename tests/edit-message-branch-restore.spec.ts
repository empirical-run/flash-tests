...
test.describe('Edit Message Branch Restore Tests', () => {
  ...
  test.skip('verify branch restore and re-execution when editing message after PR merge', // skipped: edit message button not supported in sandbox mode async ({ page, customContextPageProvider, trackCurrentSession }) => {
