...
test.describe('GitHub PR Status Tests', () => {
  ...
  test('investigate session 2180 status', async ({ page }) => {
    await page.goto('/');
    // TODO(agent on page): Navigate to sessions, find session 2180, check its current status and tool execution results
  });
