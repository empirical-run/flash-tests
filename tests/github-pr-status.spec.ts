...
import { createSession, navigateToSessions, waitForFirstMessage, getSessionBranchNames, openReviewPanel, waitForPRButton } from "./pages/sessions";
...
test.describe('GitHub PR Status Tests', () => {
  test('create session, send message, detect branch, create PR, and verify PR status in UI', async ({ page, trackCurrentSession }) => {
    ...
    // Wait for the PR button to appear
