...
import { createApiKey, createApiKeyAndCopyValue, deleteApiKey, getApiKeyRequestHeaders } from "./pages/api-keys";
...
test.describe("API Keys", () => {
  ...
  test("create API key, disable it, re-enable it, and send successful API request", async ({ page }) => {
    ...
    const apiKey = await createApiKeyAndCopyValue(page, apiKeyName);
