...
import { appendPromptAndSubmitNewSessionDialog, navigateToSessions, openNewSessionDialog } from "./pages/sessions";
...
test.describe('Session file uploads', () => {
  test('upload file via drag and drop during session creation', async ({ page, trackCurrentSession }) => {
    ...
    await appendPromptAndSubmitNewSessionDialog(page, SESSION_PROMPT);
