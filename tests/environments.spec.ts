...
test.describe("Environments Page", () => {
  test("enable/disable environment and verify in test run trigger", async ({ page }) => {
    ...
    // Navigate to Environments - Click Settings button first to expand the menu
    ...
    // Go back to environments page - Click Settings button first to expand the menu
    await page.getByRole('button', { name: 'Settings' }).click();
    await page.getByRole('link', { name: 'Environments' }).click();
    ...
    // Go back to environments and enable it back - Click Settings button first to expand the menu
    await page.getByRole('button', { name: 'Settings' }).click();
    await page.getByRole('link', { name: 'Environments' }).click();
