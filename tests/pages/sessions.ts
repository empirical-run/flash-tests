...
/**
 * Appends a prompt to an already-open new session dialog and creates the session.
 * Useful when the prompt input already contains uploaded-file links that must be preserved.
 *
 * Assumes the Create new session dialog is already open.
 *
 * @param page   The Playwright page object
 * @param prompt The prompt text to append before creating the session
 */
