...
/**
 * Fills the active session chat message input and returns the textbox locator.
 *
 ...
 */
async function fillSessionMessageInput(page: Page, message: string): Promise<Locator> {
