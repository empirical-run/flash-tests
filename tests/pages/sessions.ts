 ...
 *
 * The message input renders as a textbox labelled "Type your message here...".
 * Use this instead of repeating the raw
 * `page.getByRole('textbox', { name: 'Type your message here...' })` chain across
 * tests and helpers.
 *
