...
/**
 * Returns the origin (scheme + host) of the page's current URL, e.g.
 * "https://dash.empirical.run". Useful for building same-origin API request
 * URLs from within a test.
 */
