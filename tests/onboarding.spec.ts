...
test.describe("Magic Link Login", () => {
  ...
  test("can request magic link for unregistered email", async ({ page }) => {
    ...
    // Note: This test may fail if the backend auth service is experiencing issues (500 errors)
    // In such cases, the app should display an error message instead of failing silently
