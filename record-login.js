async page => {
  ...
  await emailBox.pressSequentially(process.env.AUTOMATED_USER_EMAIL, { delay: 70 });
  ...
  await passwordBox.pressSequentially(process.env.AUTOMATED_USER_PASSWORD, { delay: 70 });
  await page.waitForTimeout(500);
